...
Visit ``http://localhost:8999/`` in your brower, you should see a Jupyter environment just like on local machines. The server contains an example notebook ``python_example/plot_GC_data.ipynb`` that you can just execute.
